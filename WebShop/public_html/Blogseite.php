    ...
    <main>
        <nav class="w3-white w3-bar w3-content-margin" >
            <ul class="breadcrumb w3-white" >
                ...
                <li><a href="Blogübersicht.php">Blogübersicht</a></li>
                <li>Shirts</li>
            </ul>
        </nav>
        <article class="w3-row-padding w3-padding-64 w3-container">
            <article class="w3-content">
                ...
                <section class="w3-third w3-center">
        ...
        <article class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
            <article class="w3-content">
                ...
                <section class="w3-twothird">
                    ...
                    <p class="w3-padding-32">Patagonia was still a fairly small company when we started to devote time
                        and money to the
