...
?>
    <main class="w3-container">
        <section class="w3-padding-16 w3-content-margin">
            <header class="w3-border-bottom"><h1>Impressum</h1></header>
            <p>Angaben gemäß § 5 TMG</p>
            <p>Hochschule Trier<br>
                Schneidershof<br>
                54293 Trier <br>
            </p>
            <p class="w3-padding-small">
            <h2 class="w3-large w3-bold">Vertreten durch: </h2>
            Vertretungsberechtigter gem. § 79 HochSchG:
            Prof. Dr. Dorit Schumann (Präsidentin der Hochschule Trier)

            <p class="w3-padding-small">
            <h2 class="w3-large w3-bold">Kontakt:</h2>
            Telefon: +49 (0)651 8103 0<br>
            Fax: +49 (0)651 8103 333<br>
            E-Mail: <a href='mailto:info@fh-trier.de'>info(at)hochschule-trier.de</a>
            <p class="w3-padding-small">
            <h2 class="w3-large w3-bold">Umsatzsteuer-ID: </h2>
            Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: 2434923493483.
            <h3 class="w3-large w3-bold">Wirtschafts-ID: </h3>
            2347829343492

            <p class="w3-padding-small">
            <h2 class="w3-large w3-bold">Aufsichtsbehörde:</h2>

            Ministerium für Wissenschaft, Weiterbildung und Kultur des Landes Rheinland-Pfalz<br>
            Mittlere Bleiche 61<br>
            D-55116 Mainz<br>
            Tel.: 0 61 31 - 16 0 (zentraler Telefondienst)<br>
            Fax: 0 61 31 - 16 29 97<br>
            E-Mail: <a href='mailto:poststelle@mwwk.rlp.de'>poststelle(at)mwwk.rlp.de</a><br>
            Internet: <a>mwwk.rlp.de</a>



            <h2 class="w3-xlarge w3-bold">Haftungsausschluss:</h2>

            <article class="w3-padding">
                <h3 class="w3-large w3-bold">Haftung für Inhalte</h3>
            ...
            <article class="w3-padding">
                <h3 class="w3-large w3-bold">Haftung für Links</h3>
            ...
            <article class="w3-padding-16">
                <h2 class="w3-large w3-bold">Urheberrecht</h2>
            ...
            <article class="w3-padding-16">
                <h2 class="w3-large w3-bold">Datenschutz</h2>
            ...
            <article class="w3-padding-16">
                <h2 class="w3-large w3-bold">Google Analytics</h2>
                ...
                wird
                Google diese Informationen gegebenenfalls an Dritte übertragen, sofern dies gesetzlich vorgeschrieben
                oder
            ...
            <article class="w3-padding-16">
                <h2 class="w3-large w3-bold">Google AdSense</h2>
                ...
                Beacons''
                (kleine unsichtbare Grafiken) zur Sammlung von Informationen. Durch die Verwendung des Web Beacons
                können
                einfache Aktionen wie der Besucherverkehr auf der Webseite aufgezeichnet und gesammelt werden. Die durch
                den
                Cookie und/oder Web Beacon erzeugten Informationen über Ihre Benutzung dieser Website (einschließlich
                Ihrer
                ...
                Beacons können Sie verhindern, indem Sie in Ihren Browser-Einstellungen ''keine Cookies akzeptieren''
                wählen
                (Im MS Internet-Explorer unter ''Extras > Internetoptionen > Datenschutz > Einstellung''; im Firefox
                unter
                ...
                Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie erhobenen Daten durch Google
                in
