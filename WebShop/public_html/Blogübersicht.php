...
?>
    ...
    <!--Blog Elemente-->
    <main class="w3-content-margin">

        <header class=" w3-border-bottom w3-border-light-gray">
            <h1 class="w3-xlarge" style="font-weight: bold">BLOG</h1>
        </header>
        ...
        <article class="w3-border-bottom w3-border-light-gray w3-margin w3-white w3-row">
            ...
            <section class="w3-twothird w3-container">
                <h4 class="w3-large w3-bold">„Trends ändern sich, Persönlichkeit und Attitude bleiben“</h4>
                <br>
        ...
        <article class="w3-border-bottom w3-border-light-gray w3-margin w3-white w3-row">
            <header class="w3-container">
                <h2 class="w3-xlarge w3-bold">Fashion Revolution Week</h2>
                <h3 class="w3-large">ekoehrer, <span class="w3-opacity">16/04/2017</span></h3>
            </header>

            <section class="w3-twothird w3-container">
                <h4 class="w3-large w3-bold">Countdown</h4>
                <p class="w3-padding">
        ...
        <article class="w3-border-bottom w3-border-light-gray w3-margin w3-white w3-row">
            <header class="w3-container">
                <h2 class="w3-xlarge w3-bold">Interview</h2>
                <h3 class="w3-large">ekoehrer, <span class="w3-opacity">03/04/2017</span></h3>
            </header>

            <section class="w3-twothird w3-container">
                <h4 class="w3-large w3-bold">MUD JEANS Blog: Interview with Ellen Köhrer</h4>
                <p class="w3-padding">
        ...
        <article class="w3-border-bottom w3-border-light-gray w3-margin w3-white w3-row">
            <header class="w3-container">
                <h2 class="w3-xlarge w3-bold">Fashion Week Berlin</h2>
                <h3 class="w3-large">ekoehrer, <span class="w3-opacity">10/01/2017</span></h3>
            </header>

            <section class="w3-twothird w3-container">

                <h4 class="w3-large w3-bold">Fashion Week Berlin
                </h4>
                <p class="w3-padding">

                    In 8 Tagen, also am 24. April, startet die Fashion Revolution Week weltweit in Memorian an den
                    Einsturz der Rana Plaza-Textilfabriken 2013 in Bangladesch. Damals wurden über 1138 Menschen unter
                    den Trümmern begraben, rund 2500 wurden zum Teil schwer verletzt. Damit so etwas nie wieder passiert
                    macht die Fashion Revolution-Bewegungen jedes Jahr zum Jahrestag Aktionen in der ganzen Welt…
