...
<section id="cart" class="w3-hide w3-container w3-light-grey">
    ...
    <article class="w3-row w3-padding w3-border-bottom">
        <div class=" w3-quarter">
            ...
            <figcaption class="w3-small"> CLASSICS BRAND SHIRT</figcaption>
        </div>
        <label class="w3-quarter">30€</label>
        <div class="w3-quarter">
            <input class=" w3-quarter w3-input" type="number" value="1" min="1" max="10" >
        </div>
        <label class="w3-quarter ">30€</label>
    </article>
    <article class="w3-row w3-padding w3-border-bottom">
