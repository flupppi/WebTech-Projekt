...
<form class="w3-container w3-padding-16" action="../includes/login.inc.php" method="post">
    ...
    <input class="w3-input" type="text" placeholder="Enter E-mail" name="mailuid" required>
    ...
    <button class="w3-button w3-green w3-mobile w3-margin-top w3-margin-bottom w3-col m2  "
            type="submit" name="login-submit">Login</button>
