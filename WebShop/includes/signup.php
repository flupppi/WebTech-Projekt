...
<form class="w3-container w3-padding-16" action="/singup.inc.php" method="post">
    ...
    <input class="w3-input " type="password" placeholder="Confirm Password" name="psw" required>
